...
function ProjectActionsMenuComponent(props: Props): JSX.Element {
    ...
    menuItems.push([(
        <Menu.Item key='view-analytics'>
            <a
                href={`/cvat/projects/${projectInstance.id}/analytics`}
                onClick={(e: React.MouseEvent) => {
                    e.preventDefault();
                    history.push({
                        pathname: `/cvat/projects/${projectInstance.id}/analytics`,
                    });
                    return false;
                }}
            >
    ...
    menuItems.push([(
        <Menu.Item key='set-webhooks'>
            <a
                href={`/cvat/projects/${projectInstance.id}/webhooks`}
                onClick={(e: React.MouseEvent) => {
                    e.preventDefault();
                    history.push({
                        pathname: `/cvat/projects/${projectInstance.id}/webhooks`,
                    });
                    return false;
                }}
            >
