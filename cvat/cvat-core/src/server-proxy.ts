...
async function userAgreements(): Promise<SerializedUserAgreement[]> {
    // const { backendAPI } = config;
    // let response = null;
    const returnAgreements = [
        {
            name: 'cvat_ai_terms_of_use',
            url: 'https://www.cvat.ai/terms-of-use',
            required: true,
            value: false,
            urlDisplayText: 'CVAT.ai Terms of Use',
            textPrefix: 'I read and accept',
        },
        {
            name: 'privacy_policy',
            url: 'https://www.cvat.ai/privacy',
            required: true,
            value: false,
            urlDisplayText: 'CVAT.ai Privacy Policy',
            textPrefix: 'I read and accept',
        },
        {
            name: 'newsletter',
            ...
            value: false,
            urlDisplayText: '',
            textPrefix: 'I would like to receive CVAT email newsletter',
        },
    ];
    try {
